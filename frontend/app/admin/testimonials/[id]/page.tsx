    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <h1 className="font-serif text-3xl font-bold text-admin-ink tracking-tight">Edit Testimonial</h1>
        </div>
          ...
          <div className="bg-admin-surface border border-admin-border rounded-3xl p-6 space-y-4 shadow-xs">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                required
                className="w-full bg-white border border-admin-border rounded-xl px-4 py-2.5 text-sm text-admin-ink focus:border-admin-primary focus:outline-none focus:ring-2 focus:ring-admin-primary/20 transition-all shadow-2xs resize-none leading-relaxed"
              />
            </div>
            <div>
